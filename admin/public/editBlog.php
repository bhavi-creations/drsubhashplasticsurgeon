                                    ...
                                    <form style='color:black;' id="editblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="filter-section mb-3">
                                            ...
                                            <select id="service" name="service" class="form-control" required>
                                                ...
                                                <option value="Cosmetic Problems" <?php echo ($service == 'Cosmetic Problems') ? 'selected' : ''; ?>>Cosmetic Problems</option>
                                                <option value="Plastic Reconstructive Problems" <?php echo ($service == 'Plastic Reconstructive Problems') ? 'selected' : ''; ?>>Plastic & Reconstructive Problems</option>
