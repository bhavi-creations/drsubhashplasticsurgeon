...
<body class="shop-page layout-landing">
				...
				<div class="main-slider mb-0 arrows-white arrows-bottom" id="mainSlider"
					...
					<!-- <div class="slide">
						<div class="img--holder" alt="subhas"  style="  max-width: 100%; height:auto;">
							<img class="image-sild" src="images/festivel_sliders/ugadhi.png" alt="newyear ">
						</div>
					</div> -->

					<!-- <div class="slide">
						<div class="img--holder" alt="subhas"  style="  max-width: 100%; height:auto;">
							<img class="image-sild" src="images/festivel_sliders/ramjan.png" alt="newyear ">
						</div>
					</div> -->
					...
					<div class="slide">
						<div class="img--holder" data-bg="images/sliders/unwanted_hair_removal.png" alt="subhas" style="  max-width: 100%;">
						</div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
				 ...
				 <div class="slide">
					...
					<div class="slide">
						<div class="img--holder" data-bg="images/sliders/liquid_Rhyinoplasty.png" alt="subhas" style="  max-width: 100%;"
							class="img-fluid"></div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
					...
					<div class="slide">
						<div class="img--holder" data-bg="images/sliders/sagging_arm.png" alt="subhas" style="  max-width: 100%;">
						</div>
						<div class="slide-content center">
							<div class="vert-wrap container">
								<div class="vert">
							...
							<div class="pr-xl-1">
								...
								<ul class="marker-list-md">
									...
									<li>M.Ch (Plastic Surgery) from Andhra Medical College and King George Hospital,
										Visakhapatnam, Andhra Pradesh</li>
									<li>Fellowship in Microsurgery (Oncoplastic Surgery) from Tata Medical Center,
										Kolkata</li>
								</ul>
							</div>
						</div>
						<div class="col-md-6 mt-4 mt-md-0">
							<div class="video-box">
								<div class="video-box-poster">
									<img src="images/homepage/about_doctor.png"
										alt="video-poster" class="img-fluid">
								</div>
								<!-- <a href="#" class="video-btn js-video-btn" data-toggle="modal"
									data-src="https://www.youtube.com/embed/I0CJfL9735A?si=yQTRNLUlabfCLZtp"
									data-target="#videoModal">
									<span>Watch Video</span>
									<span><i class="icon-play"></i></span>
								</a> -->
								<div class="video-box-bg"><img
										src="images/homepage/video_poster_bg_best_plastic_surgery_hospitals_in_kakinada.png"
										alt="video-poster-bg"></div>
							</div>
							<!-- Video Modal -->
				...
				<div class="container-fluid px-0 text-image-block">
					<div class="row no-gutters">
						<div class="col-md-6 image-col">
							<img
								src="images/homepage/why_choose_us_plastic_surgeon_in_kakinada.png" alt="why-choose-us">
						</div>
						<div class="col-md-6 text-col">
							...
							<ul class="numbered-list-xl">
								<li data-num='01.'>
									...
									While our team brings important experience and knowledge, we know that each patient
									is the expert in their own life.
								</li>
								<li data-num='02.'>
									<h5>Comprehensive</h5>
									We offer comprehensive health care focusing on the whole person, at all ages and
									stages of life.
								</li>
								<li data-num='03.'>
									<h5>Patient-Centred</h5>
    ...
    <section class="faq-section section-padding">
        <div class="faq-bg bg-cover d-none d-lg-block" style="background-image: url('images/content/why-choose-us.png')"></div>
        <div class="container">
            <div class="row">
			...
			<div class="section" id="servicesSection" style="margin: 0px; padding: 40px 0px !important;">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							<div class="m-10">
								<img src="./images/homepage/Cosmetic_problems_best_plastic_surgery_in_kakinada.png"
									class="img-fluid mb-3" alt="Cosmetic problems">
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							<img src="./images/homepage/Plastic&Reconstructive_Problems_plastic_surgeon_in_kakinada.png"
								class="img-fluid mb-3" alt="service2">
						</div>
						<div class="col-md-3 col-lg-4">
							<ul class="marker-list-md ">
			...
			<!-- <div class="section" id="gallerySection" style="margin: 0px; padding: 40px 0px !important;">
				<div class="container">
					<div class="title-wrap text-center">
						<h2 class="h1">One stop solution for all your needs  with world’s best equipments</h2>
						<div class="h-decor"></div>
					</div>
					<div class="row">
						<div class="col-lg-6 col-sm-12 col-md-6 mb-2">
                           <img src="images/homepage/major_services.jpg" alt="" class="img-fluid">
						</div>
						<div class="col-lg-6 col-sm-12 col-md-6">
							<img src="images/homepage/major_services2.jpg" alt="" class="img-fluid">
						</div>
					</div>
				</div>
			</div> -->
				...
				<div class="container">
					...
					<div style="text-align: center; ">
						<div class="slide-btn mt-5">
							<a href="gallery.html" class="btn link-inside" data-animation="fadeInUp" data-animation-delay="2s">
								<i class="icon-right-arrow"></i><span>See More</span><i class="icon-right-arrow"></i>
							</a>
						</div>
					</div>
			...
			<div class="section" id="gallerySection" style="margin: 0px; padding: 40px 0px !important;">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 p-2 pt-0 mt-2">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/g28KJoOp3-4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
						</div>

						<div class="col-md-4 col-sm-12 p-2 pt-0 mt-2">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/w3_9zqMq9mU?si=NE3Hj3PRL22_k9No" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
						</div>

						<div class="col-md-4 p-2 pt-0 mt-2">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/LCJS1Gdgjq8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
						</div>
				...
				<div style="text-align: center; ">
					<div class="slide-btn mt-5">
						<a href="galleryvideo.html" class="btn link-inside" data-animation="fadeInUp" data-animation-delay="2s">
							<i class="icon-right-arrow"></i><span>See More</span><i class="icon-right-arrow"></i>
						</a>
					</div>
				</div>
			...
			<!--// Ending  Videos  section -->

			<hr>


			<!-- <div class="section" id="contactSection"
				style="margin: 0px; padding: 100px 0px 0px 0px !important; background:#fff">
				<div class="banner-contact-us">
					<div class="container">
						<div class="row no-gutters">
							<div
								class="col-sm-6 col-lg-6   mt-3 mt-md-0 text-center text-md-right d-flex align-items-end ">
								<img src="images/homepage/get_in_touch.png"
									alt="banner-callus" class="shift-left mb-2">
							</div>
