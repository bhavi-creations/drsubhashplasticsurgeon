				...
				if (forms.contactForm.length) {
					...
					$contactform.validate({
						...
						submitHandler: function submitHandler(form) {
                            ...
                            $submitButton.html('Sending...'); // Change button text to 'Sending...'
                            $submitButton.prop('disabled', true); // Disable the button during the AJAX request
                            ...
                            $(form).ajaxSubmit({
                                ...
                                success: function success() {
                                    ...
                                    $submitButton.html('Send Request'); // Change button text to 'Sent'
                                },
                                error: function error() {
                                    $('.errorform', $contactform).fadeIn();
                                    $submitButton.html('Error'); // Change button text to 'Error'
                                },
