...
<!--header-->	
	<!-- <div class="settings-panel">
        ...
        <a href="index.php" class="active"><img src="color/screen-layout-4.png" alt=""></a>        <a href="http://websmirno.site/medin/html/medeye-html/"><img src="color/screen-layout-5.png" alt=""></a>
		...
		<div class="container">
			<div class="row align-items-lg-center">
				...
				<div class="col-lg-auto col-lg-2 d-flex align-items-lg-center">
					<a href="index.php" class="header-logo"><img src="images/homepage/logo_best_plastic_surgery_hospitals_in_kakinada.png" alt="logo" class="img-fluid"></a>
				</div>
